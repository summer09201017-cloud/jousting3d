...
- 自動面向(07-16):AUTO_FACE_RANGE=12 內未按 A/D、未衝刺時自動轉向對手(高速背對不硬拉);出手/大招瞬間攻距內直接轉身面對再判定(玩家限定輔助)。
- 突進技(07-16):衝刺 ≥0.35s 後按出手——遠距帶(8-16m)=跳殺(拋物線躍撲 airY,落地斬 1.6x)、近距帶(3-8m)=飛殺(1.8x 衝刺速爆發突進,接觸 2.4m 斬 1.5x);TECH_CD 3.5s 共用冷卻,玩家限定。
